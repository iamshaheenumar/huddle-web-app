...
export default function DashboardLoading() {
  return (
    <div className="flex flex-col">
      ...
      {/* Hero budget card */}
      <div className="mx-5 mt-4 rounded-3xl p-5" style={{ background: 'linear-gradient(152deg,#4D79F8 0%,#3461E8 100%)' }}>
      ...
      <div className="flex gap-2.5 px-5 mt-3">
        {[0, 1, 2, 3].map(i => (
          <div key={i} className="flex-1 rounded-[18px] p-3 flex flex-col items-center gap-2" style={{ background: '#fff', border: '1px solid #F0ECE4' }}>
      ...
      <div className="mx-5 mt-3 flex flex-col gap-2.5 pb-4">
        {[0, 1, 2, 3].map(i => (
          <div key={i} className="flex items-center gap-3 rounded-2xl p-3" style={{ background: '#fff', border: '1px solid #F0ECE4' }}>
